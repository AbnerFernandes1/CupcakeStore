    ...
    public partial class CreateInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "PROMO10", new DateTime(2025, 11, 5, 22, 54, 59, 777, DateTimeKind.Local).AddTicks(5236), null, false, new DateTime(2025, 12, 5, 22, 54, 59, 777, DateTimeKind.Local).AddTicks(5248), 0, 100, 10m },
                    { 2, true, "CUPCAKE5", new DateTime(2025, 11, 5, 22, 54, 59, 777, DateTimeKind.Local).AddTicks(5255), null, true, new DateTime(2026, 1, 5, 22, 54, 59, 777, DateTimeKind.Local).AddTicks(5256), 0, 0, 5m }
                });
